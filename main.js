...
const translations = {
    en: {
        ...
        tec_bp: "Technologies used: Java, Spring Boot, PostgreSQL, Docker, ChatGPT API, Thymleaf, HTML, CSS, JavaScript.",
        tec: "Technologies used: Java, Spring Boot, PostgreSQL, Thymleaf, HTML, CSS, JavaScript.",
